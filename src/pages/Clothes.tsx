...
const Clothes: React.FC<ClothesProps> = ({ cart, setCart, setIsCartOpen }) => {
        ...
        <div className="flex justify-center">
          <div className="grid grid-cols-4 gap-x-2 gap-y-6">
            {filteredProducts.map((product) => (
              ...
              >
                {/* Add to Cart Button (Above the Image) */}
                <button 
                  className="absolute top-2 left-2 bg-black text-white px-3 py-1 rounded-md text-sm"
                ...
                <div 
                  className="relative w-full aspect-[4/5] rounded-lg overflow-hidden cursor-pointer mt-8"
