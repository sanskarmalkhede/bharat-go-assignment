...
import Details from "../components/Details"; // Importing Details Component
...
const All: React.FC<AllProps> = ({ cart, setCart, setIsCartOpen }) => {
          ...
          <div className="grid grid-cols-4 gap-x-2 gap-y-6">
            {filteredProducts.slice(0, 12).map((product) => (
              ...
              >
                ...
                {/* Category Tag */}
                <div className="absolute bottom-[85px] left-2 bg-white shadow px-2 py-1 text-xs rounded-md">
